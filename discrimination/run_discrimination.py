...
import sys
sys.path.append('/home/ProfYang/Project/FakeNews/grover-master')
...
flags.DEFINE_integer("batch_size", 4, "Batch size used")
...
def main(_):
    ...
    for split in splits_to_predict:
        ...
        for i, res in enumerate(tqdm(estimator.predict(input_fn=val_input_fn, yield_single_examples=True))):
